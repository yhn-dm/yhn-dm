...
- [AI Prompt Queue](https://github.com/yhn-dm/ai-prompt-queue-chromeext) – Chrome extension for ChatGPT/Claude/Gemini/Grok orchestration, productivity and performance: queue prompts, keep history, and run AI workflows without losing context.
